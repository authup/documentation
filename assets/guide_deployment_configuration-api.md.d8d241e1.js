import{_ as s,o as a,c as n,S as l}from"./chunks/framework.7f03344f.js";const f=JSON.parse('{"title":"Configuration","description":"","frontmatter":{},"headers":[],"relativePath":"guide/deployment/configuration-api.md","filePath":"guide/deployment/configuration-api.md"}'),p={name:"guide/deployment/configuration-api.md"},o=l(`<h1 id="configuration" tabindex="-1">Configuration <a class="header-anchor" href="#configuration" aria-label="Permalink to &quot;Configuration&quot;">​</a></h1><p>The API configuration can be provided in different file formats, such as <code>authup.api.{conf,js,ts,...}</code>.</p><p>The environment variables in the .env file variant can also be provided via runtime environment.</p><div class="vp-code-group"><div class="tabs"><input type="radio" name="group-ElN6y" id="tab-lKwVSaS" checked="checked"><label for="tab-lKwVSaS">authup.api.ts</label><input type="radio" name="group-ElN6y" id="tab-55_f4FX"><label for="tab-55_f4FX">authup.api.conf</label><input type="radio" name="group-ElN6y" id="tab-TwlrtlN"><label for="tab-TwlrtlN">.env</label></div><div class="blocks"><div class="language-typescript active"><button title="Copy Code" class="copy"></button><span class="lang">typescript</span><pre class="shiki material-theme-palenight has-diff"><code><span class="line"><span style="color:#89DDFF;font-style:italic;">export</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;font-style:italic;">default</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">{</span></span>
...
<span class="line"><span style="color:#A6ACCD;">ROBOT_SECRET_RESET=false</span></span></code></pre></div></div></div>`,4),e=[o];function t(c,i,r,y,C,D){return a(),n("div",null,e)}const F=s(p,[["render",t]]);export{f as __pageData,F as default};
