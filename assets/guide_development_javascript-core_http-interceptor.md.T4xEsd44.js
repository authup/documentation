import{_ as s,o as n,c as a,R as p}from"./chunks/framework.8k-_6wIf.js";const u=JSON.parse('{"title":"HTTP Interceptor","description":"","frontmatter":{},"headers":[],"relativePath":"guide/development/javascript-core/http-interceptor.md","filePath":"guide/development/javascript-core/http-interceptor.md"}'),e={name:"guide/development/javascript-core/http-interceptor.md"},l=p(`<h1 id="http-interceptor" tabindex="-1">HTTP Interceptor <a class="header-anchor" href="#http-interceptor" aria-label="Permalink to &quot;HTTP Interceptor&quot;">​</a></h1><p>The interceptor method, can be used for a <a href="./token-creator.html">token creator</a> strategy, a request interceptor to mount a <a href="https://github.com/tada5hi/hapic" target="_blank" rel="noreferrer">hapic</a> based http client.</p><p>If the request fails due to a non-existent, expired or invalid token, a new token is set using the token creator strategy.</p><h2 id="hapic" tabindex="-1">Hapic <a class="header-anchor" href="#hapic" aria-label="Permalink to &quot;Hapic&quot;">​</a></h2><div class="language-typescript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">typescript</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">import</span><span style="color:#E1E4E8;"> { mountClientResponseErrorTokenHook } </span><span style="color:#F97583;">from</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">&#39;@auhtup/core&#39;</span><span style="color:#E1E4E8;">;</span></span>
...
<span class="line"><span style="color:#24292E;">    }</span></span>
<span class="line"><span style="color:#24292E;">});</span></span></code></pre></div>`,5),o=[l];function t(r,c,i,E,y,h){return n(),a("div",null,o)}const m=s(e,[["render",t]]);export{u as __pageData,m as default};
